...
::::: columns
::: {.column width="50%"}
![](pic/R1.png){fig-align="center" width="80%" fig-alt="R on MSI"}
:::

::: {.column width="50%"}
![](pic/R2_Agate.png){fig-align="center" width="80%" fig-alt="R on MSI 2"}
:::
:::::
...
![](pic/R3_Agate.png){fig-align="center" width="80%" fig-alt="R on MSI 3"}
...
::::: columns
::: {.column width="50%"}
![](pic/temp1.png){fig-align="center" width="80%" fig-alt="Project template"}
:::

::: {.column width="50%"}
![](pic/temp2.png){fig-align="center" width="80%" fig-alt="Project template 2"}
:::
:::::
...
![](pic/gitclone.png){fig-align="center" width="80%" fig-alt="Git clone"}
...
::::: columns
::: {.column width="75%"}
![](pic/rename.png){fig-align="center" width="80%" fig-alt="Rename rproj"}
:::

::: {.column width="25%"}
![](pic/rproj.png){fig-align="center" width="80%" fig-alt="Rename rproj 2"}
:::
:::::
...
![](pic/Github1.png){fig-align="center" width="90%" fig-alt="Git repo"}

![](pic/Github2.png){fig-align="center" width="90%" fig-alt="Git repo 2"}
...
::::: columns
::: {.column width="50%"}
![](pic/Github3.png){fig-align="center" width="90%" fig-alt="Git repo 3"}
:::

::: {.column width="50%"}
![](pic/Github4.png){fig-align="center" width="90%" fig-alt="Git repo 4"}
:::
:::::
...
![](pic/renv.png){fig-align="center" width="80%" fig-alt="renv"}
...
![](pic/renv1.png){fig-align="center" width="100%" fig-alt="renv 2"}
:::
...
![](pic/renv2.png){fig-align="center" width="100%" fig-alt="renv 3"}
:::
:::::
...
![](pic/bbi1.png){fig-align="center" width="80%" fig-alt="bbi"}
...
![](pic/bbi2.png){fig-align="center" width="60%" fig-alt="bbi2"}
