...
image: "pic/image.png"
image-alt: "Finch Studio and MSI"
filters:
  - highlight-text
format:
  html: 
...
![](pic/fs1.png){fig-align="center" width="100%" fig-alt="Connect FS with MSI"}

-   A connection setting window will pop-up. 

![](pic/fs2.png){fig-align="center" width="100%" fig-alt="Connect FS with MSI 2"}
...
![](pic/fs3.png){fig-align="center" width="100%" fig-alt="Connect FS with MSI 3"}

-   The configuration of local and remote mount points is illustrated as shown below.

    *   Local project path: [X:/User/SmithJ]{bg-colour="#E76E5BFF"}[/documents/project1]{bg-colour="#FDCB26FF"}
        *   [Local mount point]{bg-colour="#E76E5BFF"}
...
![](pic/fs4.png){fig-align="center" width="100%" fig-alt="Connect FS with MSI 4"}
...
![](pic/fs5.png){fig-align="center" width="100%" fig-alt="Connect FS with MSI 5"}
...
![](pic/fs6.png){fig-align="center" width="100%" fig-alt="Connect FS with MSI 6"}
...
![](pic/fs7.png){fig-align="center" width="100%" fig-alt="Connect FS with MSI 7"}

-   Then we can drag to copy the whole project directory from local to remote mount point.

![](pic/fs8.png){fig-align="center" width="100%" fig-alt="Connect FS with MSI 8"}

-   In **Remote** option under **CONSOLE** tab, make sure you enter the model directory that you'd like to execute first. 

![](pic/fs9.png){fig-align="center" width="100%" fig-alt="Connect FS with MSI 9"}
...
![](pic/fs10.png){fig-align="center" width="100%" fig-alt="Connect FS with MSI 10"}
...
![](pic/fs11.png){fig-align="center" width="100%" fig-alt="Connect FS with MSI 11"}
...
![](pic/fs12.png){fig-align="center" width="100%" fig-alt="Connect FS with MSI 12"}
...
![](pic/fs13.png){fig-align="center" width="100%" fig-alt="Connect FS with MSI 13"}

![](pic/fs14.png){fig-align="center" width="100%" fig-alt="Connect FS with MSI 14"}

-   Finch Studio requires different `NONMEM` output files for different purposes as shown in the table below: 

![](pic/file-table.png){fig-align="center" width="70%" fig-alt="File table"}
...
![](pic/fs15.png){fig-align="center" width="100%" fig-alt="Connect FS with MSI 15"}
...
![](pic/fs16.png){fig-align="center" width="100%" fig-alt="Connect FS with MSI 16"}
